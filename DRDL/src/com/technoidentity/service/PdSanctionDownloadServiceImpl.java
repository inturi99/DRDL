...
@Service
public class PdSanctionDownloadServiceImpl {
	@Autowired
	private ExporterService exporter;
	@Autowired
	private PdSanctionReportService pdSanctionReportService;
	public static final String TEMPLATE = "/pdsanction.jrxml";
	public static final String outPdf ="/pdsanction.pdf";
	...
	public HttpServletResponse download(HttpServletResponse response,String id)  {
		...
		try {
			...
			params.put("Title", "PdSanction Report");
			...
			JasperPrint jp = JasperFillManager.fillReport(jr, params,pdSanctionReportService.getPdSanctionId(id));
	...
	*/
	private HttpServletResponse write(HttpServletResponse response,
		...
		try {
			...
			response.setHeader("Content-Disposition","attachment; filename= pdsanction.pdf"); 
