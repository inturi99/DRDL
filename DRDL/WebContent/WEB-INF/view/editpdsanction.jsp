		...
		<div class="col-sm-offset-1 col-sm-10">
			<div class="panel panel-primary ">
				<div class="panel-heading">
					<h4 class=" panel-title text-center">Edit PD Sanction</h4>
				</div>
				<div class="panel-body">

					<form:form modelAttribute="pdSanctionDto" id="pdsanctionDto"
						method="post" action="${saveUrl}" cssClass="form-horizontal">
						<div class="form-group">
							<label for="propcode" class="col-sm-2 control-label">PropCode</label>
							<div class="col-sm-4">
								<form:select path="propcode" cssClass="form-control">
									<form:option label="-- Select Prop Code --"
										value="-1" />
				...
				<div class="form-group">
							<div class="col-lg-offset-2 col-lg-10">
								<button type="submit" class="btn btn-primary">
									<spring:message code="label.updatepdsanction" />
								</button>
					</div>
				</div>
