				...
				<div class="panel-body">
					...
					<form:form modelAttribute="employee" method="post"
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<form:input id="txt-image" type="hidden" path="photo" placeholder="photo"
											cssClass="form-control" />
						...
						<div class="form-group">
							<label for="idcardno" class="col-sm-2 control-label">ID CARD NUMBER</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							...
							<div class="form-group">
							<label for="dol" class="col-sm-2 control-label">DATE OF LEAVING</label>
							<div class="col-sm-9">
							...
							<div class="form-group">
							<label for="pmcode" class="col-sm-2 control-label">PRIME CODE</label>
							<div class="col-sm-9">
							...
							<div class="form-group">
							<label for="pphone" class="col-sm-2 control-label">PERMANENT PHONE NO.</label>
							<div class="col-sm-9">
							...
							<div class="form-group">
							<label for="tphone" class="col-sm-2 control-label">TEMPORARY PHONE NO.</label>
							<div class="col-sm-9">
							...
							<div class="form-group">
							<label for="start_sal" class="col-sm-2 control-label">START SALARY</label>
							<div class="col-sm-9">
							...
							<div class="form-group">
							<label for="board_type" class="col-sm-2 control-label">BOARD TYPE</label>
							<div class="col-sm-9">
