		...
		<div class="col-sm-offset-1 col-sm-10">
			...
			<div class="panel panel-primary ">
				<div class="panel-heading">
					<h4 class=" panel-title text-center">Edit SoClearence</h4>
				</div>
				<div class="panel-body">

					<form:form modelAttribute="soClearenceDto" id="soclearenceDto"
						...
						<div class="form-group">
							<label for="demandingofficer" class="col-sm-2 control-label">Demanding
								Officer</label>
							<div class="col-sm-4">
								<form:input path="demandingofficer" id="demandingofficer"
						...
						<div class="form-group">
							<div class="col-lg-offset-2 col-lg-10">
								<button type="submit" class="btn btn-primary">
									<spring:message code="label.updatesoclearence" />
								</button>
							</div>
						</div>
					</form:form>
